...
use App\Support\Csp\FilamentPreset;
...
return [
     ...
     *
     * Disabled by default: Filament (Livewire + Alpine) emits inline scripts
     * and styles that cannot be nonced, and a nonce makes browsers ignore the
     * 'unsafe-inline' that Filament requires. See App\Support\Csp\FilamentPreset.
     */
